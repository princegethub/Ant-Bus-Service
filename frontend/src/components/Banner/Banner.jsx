...
import { MdBusAlert, MdFlight, MdOutlineLocalHotel } from "react-icons/md";
          ...
          <div className="container">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-center">
              ...
              <div className="flex flex-col justify-center gap-6 sm:pt-0 lg:px-16">
                ...
                >
                  Join us on an unforgettable journey to the most beautiful
                  places on Earth. Experience the adventure of a lifetime with
                  our expert guides and top-notch services.
                  <br />
                </p>
                <div data-aos="zoom-in" className="grid grid-cols-2 gap-6">
                  <div className="space-y-6">
                    <div className="flex items-center gap-4">
                      <FaBus className="text-4xl h-12 w-12 shadow-sm p-4 rounded-full bg-violet-100 dark:bg-violet-400" />
                      <p>Bus</p>
                    </div>
                    <div className="flex items-center gap-4">
